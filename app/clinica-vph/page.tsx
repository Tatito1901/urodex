...
export default function ClinicaVphPage() {
  ...
  const benefits = [
    {
      ...
      description:
        "Utilizamos técnicas avanzadas de detección como colposcopía y peniscopía para identificar lesiones por VPH.",
    },
    {
      icon: <Zap className="h-8 w-8 text-green-700" />,
      title: "Tratamientos Modernos",
      description:
        "Aplicamos las terapias más efectivas incluyendo láser, crioterapia y tratamientos tópicos especializados.",
    },
    {
      icon: <Heart className="h-8 w-8 text-green-700" />,
      title: "Atención Confidencial",
      description:
        "Brindamos un ambiente seguro y confidencial para el tratamiento de infecciones de transmisión sexual.",
    },
    {
      icon: <Microscope className="h-8 w-8 text-green-700" />,
      title: "Seguimiento Especializado",
      description: "Monitoreo continuo para prevenir recidivas y detectar tempranamente cualquier complicación.",
    },
  ]
  ...
  const treatments = [
    {
      name: "Crioterapia",
      description: "Eliminación de verrugas genitales mediante aplicación de frío extremo.",
    ...
    },
    {
      ...
      description: "Aplicación de medicamentos que estimulan el sistema inmune local.",
      duration: "Aplicación en casa",
      recovery: "Varias semanas",
    },
  ]
      ...
      <main className="flex-1">
          ...
          <ResponsiveContainer className="py-12 md:py-20 lg:py-28 relative flex flex-col justify-center min-h-[calc(100vh-5rem)]">
            <ScrollAnimation animation="fade-in-up" className="max-w-4xl mx-auto text-center space-y-4 md:space-y-6">
              ...
              <TypographyP className="text-green-800 font-medium text-lg md:text-xl lg:text-2xl px-4">
                Diagnóstico y tratamiento especializado del Virus del Papiloma Humano con las técnicas más avanzadas y
                efectivas.
              </TypographyP>
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <ScrollAnimation animation="fade-in-up" delay={200}>
                <div className="text-center">
                  <div className="text-3xl md:text-4xl font-bold text-green-700 mb-2">1000+</div>
                  <div className="text-gray-600">Pacientes Tratados</div>
                </div>
              </ScrollAnimation>
              ...
              <ScrollAnimation animation="fade-in-up" delay={400}>
                <div className="text-center">
                  <div className="text-3xl md:text-4xl font-bold text-green-700 mb-2">10+</div>
          ...
          <ResponsiveContainer>
            <ScrollAnimation animation="fade-in-up">
              <div className="text-center content-narrow mb-16">
                <TypographyH2 className="mb-4 text-green-700">¿Por qué elegir nuestra clínica para VPH?</TypographyH2>
                <div className="w-20 h-1 bg-green-700 mx-auto mb-6"></div>
                <TypographyP className="text-green-700">
                  Ofrecemos el tratamiento más completo y efectivo para el VPH con tecnología de vanguardia y un enfoque
        ...
        <Section id="servicios" background="white" spacing="lg">
          <ResponsiveContainer>
            <ScrollAnimation animation="fade-in-up">
              <div className="text-center content-narrow mb-16">
                <TypographyH2 className="mb-4 gradient-text">Tratamientos Especializados para VPH</TypographyH2>
                <div className="w-20 h-1 bg-green-500 mx-auto mb-6"></div>
                <TypographyP>
                  Ofrecemos una amplia gama de tratamientos para el VPH, desde terapias conservadoras hasta
              ...
              {treatments.map((treatment, index) => (
                <ScrollAnimation key={index} animation="fade-in-up" delay={index * 100}>
                  <div className="bg-gradient-to-br from-green-50 to-white rounded-xl p-8 border border-green-100 hover:shadow-lg transition-all duration-300">
                    <h3 className="text-xl font-bold text-green-700 mb-4">{treatment.name}</h3>
                    <p className="text-gray-600 mb-6">{treatment.description}</p>

                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div>
                        <div className="text-sm text-gray-500 mb-1">Duración</div>
                        <div className="font-medium text-green-700">{treatment.duration}</div>
                      </div>
                      <div>
                        <div className="text-sm text-gray-500 mb-1">Recuperación</div>
                        <div className="font-medium text-green-700">{treatment.recovery}</div>
                      </div>
                    </div>
          ...
          <ResponsiveContainer>
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
              ...
              <ScrollAnimation animation="fade-in-left" className="md:w-3/5 space-y-8">
                <div>
                  <h3 className="text-xl text-green-600 mb-2">Tu especialista en tratamiento de VPH</h3>
                ...
                <TypographyP>
                  Cirujano Urólogo especializado en el diagnóstico y tratamiento del Virus del Papiloma Humano (VPH) con
                  más de 10 años de experiencia. Certificado en el manejo integral de infecciones de transmisión sexual
                  y técnicas avanzadas de tratamiento.
                </TypographyP>

                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-green-600" />
                    <span className="text-gray-700">Más de 1000 casos de VPH tratados exitosamente</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-green-600" />
                    <span className="text-gray-700">Especialización en colposcopía y peniscopía</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-green-600" />
                    <span className="text-gray-700">Certificación en tratamientos láser para VPH</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-green-600" />
                    <span className="text-gray-700">Enfoque integral en prevención y seguimiento</span>
                  </div>
                </div>
        ...
        <Section background="white" spacing="lg">
          <ResponsiveContainer>
            <ScrollAnimation animation="fade-in-up">
              <div className="text-center content-narrow mb-16">
                <TypographyH2 className="mb-4 gradient-text">Preguntas Frecuentes sobre VPH</TypographyH2>
                <div className="w-20 h-1 bg-green-500 mx-auto mb-6"></div>
                <TypographyP>
                  Respuestas a las dudas más comunes sobre el Virus del Papiloma Humano y su tratamiento.
                </TypographyP>
              </div>
            </ScrollAnimation>
                ...
                <Accordion type="single" collapsible className="space-y-4">
                  ...
                  >
                    ...
                    <AccordionContent className="px-6 pb-4 text-gray-600">
                      <p>
                        El Virus del Papiloma Humano (VPH) es una infección de transmisión sexual muy común. Se
                        transmite principalmente a través del contacto sexual (vaginal, anal u oral) con una persona
                        infectada. Existen más de 100 tipos de VPH, algunos causan verrugas genitales y otros pueden
                  ...
                  >
                    ...
                    <AccordionContent className="px-6 pb-4 text-gray-600">
                      <p>
                        Muchas personas con VPH no presentan síntomas y pueden no saber que están infectadas. Los
                        síntomas más comunes incluyen: verrugas genitales (pequeñas protuberancias en los genitales),
                        verrugas en la garganta, y en casos de VPH de alto riesgo, cambios celulares que pueden
                        detectarse en exámenes de rutina como el Papanicolaou.
                      </p>
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  >
                    ...
                    <AccordionContent className="px-6 pb-4 text-gray-600">
                      <p>
                        Aunque no existe una cura específica para el virus del VPH, sí existen tratamientos muy
                        efectivos para las lesiones que causa. En muchos casos, el sistema inmunológico puede eliminar
                        el virus naturalmente. Los tratamientos disponibles incluyen crioterapia, láser,
                        electrocauterización y medicamentos tópicos que pueden eliminar las verrugas y lesiones.
                      </p>
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  >
                    ...
                    <AccordionContent className="px-6 pb-4 text-gray-600">
                      <p>
                        La prevención del VPH incluye: vacunación (recomendada para adolescentes y adultos jóvenes), uso
                        de preservativos (aunque no ofrecen protección completa), limitar el número de parejas sexuales,
                        y realizarse exámenes de detección regulares. La vacuna contra el VPH es altamente efectiva para
                        prevenir los tipos más comunes del virus.
                      </p>
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  >
                    <AccordionTrigger className="hover:bg-green-50 px-6 py-4 text-left font-medium text-green-800 text-lg focus-visible-ring">
                      ¿Cuánto tiempo toma el tratamiento del VPH?
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-4 text-gray-600">
                      <p>
                        La duración del tratamiento varía según el tipo y extensión de las lesiones. Los tratamientos
                        como crioterapia o láser pueden requerir una o varias sesiones. Los medicamentos tópicos pueden
                        aplicarse durante varias semanas. Es importante el seguimiento médico regular para monitorear la
                        respuesta al tratamiento y prevenir recidivas.
                      </p>
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
      ...
      <footer className="bg-green-700 text-white py-16">
        <ResponsiveContainer>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            <div>
              ...
              <p className="text-green-100 text-base leading-relaxed">
                Clínica especializada en el tratamiento del VPH en Ciudad de México, ofreciendo atención médica
                confidencial y de la más alta calidad.
              </p>
            ...
            <div>
              <h3 className="font-medium text-xl mb-6 font-serif">Tratamientos</h3>
              <ul className="space-y-4">
                <li>
                  <Link
                    href="#"
          ...
          <div className="border-t border-green-600 mt-12 pt-8 text-center text-green-100 text-base">
            <p>© {new Date().getFullYear()} Urodex - Clínica de Tratamiento de VPH. Todos los derechos reservados.</p>
          </div>
        </ResponsiveContainer>
      </footer>
    </div>
